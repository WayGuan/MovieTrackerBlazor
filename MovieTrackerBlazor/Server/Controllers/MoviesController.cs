...
namespace MovieTrackerBlazor.Server.Controllers
{
    ...
    public class MoviesController : ControllerBase
    {
        ...
        public MoviesController(MovieTrackerBlazorServerContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<IEnumerable<Movie>>> GetMovie()
        {
            ...
            return await _context.Movie.Include(m => m.Genre).ToListAsync(); // lazy loading is not getting Genre object
        }
